...
It's pretty neat, huh? It has got a lot of cool features that my old website didn't have. And it also looks a _lot_ better now.
...
Furthermore I can make things _italic_, __bold__, ~~strikethrough~~~, or, best of all:
```csharp
...
This website will also function as my main way of putting _me_ out there. If there's some job application I'll be sure to refer them to this website.
And if you happen to be a job recruiter looking at this blog. Hi there!

As for the blog. I want to document my "_code adventures_". If I do something cool I want to write about it: Share my findings. Maybe it's useful to somebody else.
